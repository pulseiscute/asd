loadstring(game:HttpGet("https://pastebin.com/raw/dptkk0cX"))();
getgenv().values = {}
local library = {}
...
function library:New(name)
	...
	cursor.ZIndex = 1000
	cursor.ImageColor3 = Color3.fromRGB(140, 13, 21)
	...
	Menu.BackgroundColor3 = Color3.fromRGB(140, 13, 21)
	...
	do
		...
		TextLabel.BorderColor3 = Color3.fromRGB(140, 13, 21)
		TextLabel.Position = UDim2.new(0, 1, 0.300000012, 0)
		TextLabel.Size = UDim2.new(0, 155, 0, 24)
		TextLabel.ZIndex = 2
		TextLabel.Font = Enum.Font.SourceSansSemibold
		TextLabel.Text = "keybinds"
		TextLabel.TextColor3 = Color3.fromRGB(140, 13, 21)
		TextLabel.TextSize = 14.000

		Frame.Parent = TextLabel
		Frame.BackgroundColor3 = Color3.fromRGB(140, 13, 21)
	...
	TextLabel.BackgroundColor3 = Color3.fromRGB(140, 13, 21)
	...
	TabButtons.BackgroundColor3 = Color3.fromRGB(140, 13, 21)
	...
	Tabs.Name = "Tabs"
	Tabs.Parent = Menu
	Tabs.BackgroundColor3 = Color3.fromRGB(140, 13, 21)
	...
	function menu:Tab(text)
		...
		TextButton.BackgroundColor3 = Color3.fromRGB(140, 13, 21)
		...
		TabGui.Name = "TabGui"
		TabGui.Parent = Tabs
		TabGui.BackgroundColor3 = Color3.fromRGB(140, 13, 21)
		...
		Left.Name = "Left"
		Left.Parent = TabGui
		Left.BackgroundColor3 = Color3.fromRGB(140, 13, 21)
		...
		Right.Name = "Right"
		Right.Parent = TabGui
		Right.BackgroundColor3 = Color3.fromRGB(140, 13, 21)
		...
		if first then
			TextButton.TextColor3 = Color3.fromRGB(140, 13, 21)
			currenttab = text
			TabGui.Visible = true
			first = false
		end
		...
		function Tab:MSector(text, side)
			...
			SectionText.BackgroundColor3 = Color3.fromRGB(140, 13, 21)
			...
			sectiontabs.BackgroundColor3 = Color3.fromRGB(140, 13, 21)
			...
			function MSector:Tab(text)
				...
				function tab:Element(type, text, data, callback)
					...
					if type == "Jumbobox" then
						...
						Dropdown.BackgroundColor3 = Color3.fromRGB(140, 13, 21)
						...
						ImageLabel.BackgroundColor3 = Color3.fromRGB(140, 13, 21)
						...
						TextLabel_3.BackgroundColor3 = Color3.fromRGB(140, 13, 21)
					...
					elseif type == "ToggleKeybind" then
						...
						Toggle.Name = "Toggle"
						Toggle.Parent = tab1
						Toggle.BackgroundColor3 = Color3.fromRGB(140, 13, 21)
						Toggle.BackgroundTransparency = 1.000
						Toggle.Size = UDim2.new(1, 0, 0, 15)

						Button.Name = "Button"
						Button.Parent = Toggle
						Button.BackgroundColor3 = Color3.fromRGB(140, 13, 21)
					...
					elseif type == "ToggleColor" then
						...
						Colorpick.BackgroundColor3 = Color3.fromRGB(140, 13, 21)
						...
						ColorDrag.BackgroundColor3 = Color3.fromRGB(140, 13, 21)
						...
						Huepick.BackgroundColor3 = Color3.fromRGB(140, 13, 21)
						...
						Huedrag.BackgroundColor3 = Color3.fromRGB(140, 13, 21)
					...
					elseif type == "ToggleTrans" then
						...
						Transpick.BackgroundColor3 = Color3.fromRGB(140, 13, 21)
						...
						Transcolor.BackgroundColor3 = Color3.fromRGB(140, 13, 21)
						...
						Transdrag.BackgroundColor3 = Color3.fromRGB(140, 13, 21)
					...
					elseif type == "Dropdown" then
						...
						Drop.AutomaticCanvasSize = "Y"
						Drop.ZIndex = 5
						Drop.ScrollBarImageColor3 = Color3.fromRGB(140, 13, 21)
					...
					elseif type == "Slider" then
						...
						Slider.Name = "Slider"
						Slider.Parent = tab1
						Slider.BackgroundColor3 = Color3.fromRGB(140, 13, 21)
						...
						Value.Name = "Value"
						Value.Parent = Slider
						Value.BackgroundColor3 = Color3.fromRGB(140, 13, 21)
		...
		function Tab:Sector(text, side)
			...
			SectionText.Font = Enum.Font.SourceSansSemibold
			SectionText.Text = text
			SectionText.TextColor3 = Color3.fromRGB(140, 13, 21)
			SectionText.TextSize = 15.000
			SectionText.TextXAlignment = Enum.TextXAlignment.Left
			...
			function Sector:Element(type, text, data, callback)
				...
				if type == "ScrollDrop" then
					...
					for i,v in ipairs(joe) do
						do
							...
							Scroll.BackgroundColor3 = Color3.fromRGB(140, 13, 21)
				...
				elseif type == "TextBox" then
					...
					Box.Name = "Box"
					Box.Parent = Inner
					Box.BackgroundColor3 = Color3.fromRGB(140, 13, 21)
					...
					TextBox.TextColor3 = Color3.fromRGB(140, 13, 21)
...
local gui = library:New("pulse.wtf")
...
world:Element("ToggleColor", "item esp", {default = {Color = Color3.fromRGB(140, 13, 21)}}, function(tbl)
...
chat:Element("Toggle", "chat spam", nil, function(tbl)
	if tbl.Toggle then
		while values.misc.chat["chat spam"].Toggle do
			game:GetService("ReplicatedStorage").Events.PlayerChatted:FireServer(values.misc.chat.type.Dropdown == "standard" and "hi" or "Get Good Get Issential", false, "Innocent", false, true)
			wait(values.misc.chat["speed (ms)"].Slider/1000)
		end
	end
end)
chat:Element("Dropdown", "type", {options = {"standard", "Issential"}})
...
do
	utility.default = {
		Line = {
			Thickness = 1.5,
			Color = Color3.fromRGB(140, 13, 21),
			Visible = false
		},
		Text = {
			Size = 13,
